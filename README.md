# SQL Project- Netflix Shows and Movies
By employing a blend of Excel, SQL, and Tableau, I meticulously examined the vast dataset encompassing more than 82,000 rows of information from Netflix's library of shows and movies. Through the process of simplifying and analyzing the data, I unveiled captivating insights and compelling facts regarding the content accessible on the platform.
# <p align="center">![Pic](https://t-mobile.scene7.com/is/image/Tmusprod/netflix-hero_desktop:Hero-super-wideNew-breakpoint?fmt=png&qlt=85,0&resMode=sharp2&op_usm=1.75,0.3,2,0)</p>
